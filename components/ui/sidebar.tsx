  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "fixed top-[var(--disclaimer-height,0px)] z-10 hidden h-[calc(100svh-var(--disclaimer-height,0px))] w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex",
          side === "left"
